...
setwd('C:/Users/joaog/Documents/Pesquisa/GBM/Scripts/Dados Clínicos/genomico')
...
head(cbind(clinical$days_to_death, clinical$days_to_last_follow_up, clinical$time, clinical$vital_status), 10)
...
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'EGFR', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'TTN', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'MUC16', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'FLG', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'NF1', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'RYR2', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'PIK3CA', time = 'time', Status = "vital_status", isTCGA = TRUE)
#not significant:
mafSurvival(maf = gbm.mafclin, genes = 'PIK3R1', time = 'time', Status = "vital_status", isTCGA = TRUE)
