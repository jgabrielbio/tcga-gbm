...
# João Gabriel - 30/12/2023

packages <- c('TCGAbiolinks', 'tidyverse', 'skimr', 'finalfit', 'tableone')
...
clinic_descript <- gbm.clinic.table %>%
  summary_factorlist(dependent, explanatory,
                     na_to_p = FALSE,
                     na_include = FALSE, add_dependent_label = TRUE, p = TRUE
  ) -> t1
# visualization
knitr::kable(t1, align=c("l", "l", "r", "r", "r"))
save_kable(tl, "finalfit_adjusted.pdf")
